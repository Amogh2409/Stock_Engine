...
| Amihud illiquidity (63-session) | `b20e86c` | **FAIL** — 1M IC +0.0435 against a 0.0446 floor, missing detection by 0.0011 with the other four conditions met. Diagnostic 3/6/12M cleared their floors; size exposure unmeasurable, so the illiquid decile may simply be the small-cap decile |
